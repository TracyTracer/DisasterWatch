  ...
  return (
    <Card className="shadow-lg">
      <CardHeader>
        ...
        <CardDescription>
          Configure your preferences for earthquake notifications (simulated).
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between space-x-2 p-3 border border-border rounded-lg">
          <Label htmlFor="notifications-enabled" className="flex flex-col space-y-1">
            ...
            <span className="font-normal leading-snug text-muted-foreground">
              Receive alerts for significant earthquakes.
            </span>
          </Label>
          <Switch
        ...
        <div className="space-y-2">
          <Label htmlFor="magnitude-threshold" className="flex items-center"><Gauge className="mr-2 h-4 w-4 text-muted-foreground"/>Minimum Magnitude</Label>
          <Input
          ...
          />
           <p className="text-xs text-muted-foreground">
            Receive alerts for earthquakes with magnitude {magnitudeThreshold} or higher.
          </p>
        </div>
